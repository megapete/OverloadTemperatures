...
class AppController: NSObject {
    ...
    @IBAction func handle_C57_91_Demo(_ sender: Any) {
        ...
        let model = OverloadModel(kvaBaseForTemperatures: 52267.0, kvaBaseForLoss: 28000.0, kVABaseForOverLoad: 52267.0, coolingMode: .ONAF, fluidType: .MINERAL_OIL, testedTemperatures: temperature, testedLosses: loss, massOfCore: massCore, massOfFluid: 4910.0, massOfTank: 31400, massOfWinding: massWdg)
